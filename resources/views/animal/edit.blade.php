...
@section('content')
  ...
  <div class="form-group">
    ...
    <input type="text" name="name" class="form-control" id="Животное" placeholder="Животное" value="{{ $animal -> name }}">
  </div>
  <div class="form-group">
    <label for="Возраст животного">Возраст животного</label>
    <input type="text" name="age" class="form-control" id="Возраст животного" placeholder="Возраст животного" value="{{ $animal -> age }}">
  </div>
  <div class="form-group">
    <label for="Вид животного">Вид животного</label>
    <input type="text" name="type" class="form-control" id="Вид животного" placeholder="Вид животного" value="{{ $animal -> type }}">
  </div>
  <div class="form-group">
